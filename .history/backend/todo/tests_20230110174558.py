...
class TestDistances(TestCase):
    def setUp(self) -> None:
        ...
        # Thomas Siebel Center for CS coords: (40.11397506604104, -88.2249588393126)
        Address.objects.create(address1="201 N Goodwin Ave", zip_code="61020", city="Champaign", lat=Decimal('40.11397506604104'),
    ...
    def test_walking_dist_between_two_address_objects(self):
        ...
        :return:
        """
        dummy1 = Address.objects.get(address1="201 E Peabody Dr", city="Champaign")
        dummy2 = Address.objects.get(address1="102 E Green St", zip_code="61001")
        # print(dummy2.lat)
        dummy2.lat = Decimal('1.000')
        dummy2.long = Decimal('0.000')

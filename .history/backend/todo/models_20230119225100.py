...
class DistanceMatrix(models.Model): 
    ...
    important_building = models.ManyToManyField(ImportantBuilding, on_delete=models.CASCADE,null=True)
    apartment =  models.ManyToManyField(Apartment, on_delete=models.CASCADE,null=True)
    # transit_time = ... 

...
class DistanceMatrix(models.Model): 
    ...
    important_building = models.OneToOneField(ImportantBuilding, on_delete=models.CASCADE,null=True)
    apartment =  models.OneToOneField(Apartment, on_delete=models.CASCADE,null=True)
    ...
    class Meta:
        unique_pair = ('self.important_building,self.apartment,)

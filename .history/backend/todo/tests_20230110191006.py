...
class TestDistances(TestCase):
    ...
    # used Openrouteservice website to determine actual distances: https://maps.openrouteservice.org/#/directions/201%20East%20Peabody%20Drive,Champaign,IL,USA/201%20North%20Goodwin%20Avenue,Urbana,IL,USA/data/55,130,32,198,15,97,4,224,38,9,96,59,2,24,5,192,166,6,113,0,184,64,90,0,57,8,14,128,38,1,152,3,96,1,128,70,66,1,160,5,134,146,233,166,194,7,98,160,110,34,164,201,150,96,21,155,157,22,108,233,208,160,19,134,156,144,140,64,64,0,234,158,4,68,216,114,128,5,229,0,45,174,58,162,85,174,129,0,25,188,0,54,233,115,128,9,230,14,210,0,230,249,163,160,240,21,206,217,26,25,68,18,221,26,221,7,209,12,17,207,7,210,8,200,221,17,22,29,22,4,0,23,195,40,0,0
    def test_walking_dist(self):
        ...
        self.assertTrue(math.isclose(walking_dist,1.3))
    ...
    def test_biking_dist(self):
        ...
        self.assertTrue(math.isclose(biking_dist,1.6,abs_tol=0.02))
    ...
    def test_driving_dist(self):
        ...
        self.assertTrue(math.isclose(driving_dist,1.6))
